...
export const projects = [
    ...
    },
    {
        ...
        src: spw,
        alt: "SPW",
        description: "A fully responsive photography studio Progressive Web App built with React, Node.js, and Sass, featuring dynamic image galleries, service and portfolio pages, client testimonials, and integrated contact and session-booking forms for seamless client enquiries.",
    ...
    },
    {
        ...
        src: mary,
        alt: "Mary",
        description: "A multilingual tailoring Progressive Web App built with React, Node.js, and Sass, featuring service pages, and a clean responsive layout, with seamless language switching for English and Hungarian visitors.",
        stack: "React, Vite, JavaScript, Sass, Node.js",
