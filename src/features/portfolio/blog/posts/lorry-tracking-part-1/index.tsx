    ...
    return (
        <>
            <article className="blog-post">
                ...
                <p className="meta">
                    Starting a new full-stack project to solve a real
                    operational problem on a busy production site.
                </p>
                ...
                <section>
                    ...
                    <p>
                        On a busy industrial production site in London, lorries
                        arrive continuously to collect finished goods. Once a
                        lorry checks in at the weighbridge, it moves through
                        several stages on site — waiting, loading, and
                        eventually checking out.
                    </p>
                ...
                <section>
                    ...
                    <p>
                        As a result, supervisors and managers frequently have
                        to interrupt staff via radio, mobile phone, or
                        face-to-face just to get verbal updates on where things
                        stand.
                    </p>
                </section>
