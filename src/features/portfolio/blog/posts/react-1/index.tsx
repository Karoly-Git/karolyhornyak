...
export default function ReactQandA() {
    ...
    return (
        <>
            <article className="blog-post">
                ...
                <p className="meta">
                    A curated list of React theoretical questions with concise
                    explanations to help you strengthen your fundamentals.
                </p>
                ...
                <section>
                    ...
                    <p>
                        ...
                        Meta (Facebook) for building fast, interactive user
                        interfaces, especially single-page applications. It
                        uses a component-based architecture and a declarative
                        UI.
                    </p>
                </section>
                ...
                <section>
                    <h2>3. What is JSX?</h2>
                    <p>
                        JSX (JavaScript XML) is a syntax extension that allows
                        writing HTML-like code inside JavaScript. It is compiled
                ...
                <section>
                    ...
                    <p>
                        Props (“properties”) are read-only data passed from
                        parent to child components. They help customize
                        components.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        State is mutable data stored inside a component. When
                ...
                <section>
                    ...
                    <ul>
                        <li>
                            <strong>Props:</strong> Immutable, set by parent
                        </li>
                        <li>
                            <strong>State:</strong> Mutable, managed by the
                            component
                        </li>
                    </ul>
                </section>
                ...
                <section>
                    ...
                    <p>
                        Hooks are functions that allow functional components to
                ...
                <section>
                    ...
                    <p>
                        A hook used for side effects like data fetching,
                        subscriptions, or timers. It runs after render.
                    </p>
                    <pre>
                        <code>
                            {`useEffect(() => {
    console.log("mount or update");
                ...
                <section>
                    ...
                    <p>
                        Sharing state between sibling components by moving it
                ...
                <section>
                    ...
                    <p>
                        Context allows passing data (theme, user, settings)
                ...
                <section>
                    ...
                    <p>
                        Passing props through multiple components even when
                        only the deepest component needs them.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        Form elements where the DOM maintains state, accessed
                        via refs.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        The process of comparing Virtual DOM trees and
                        efficiently updating the real DOM using a diffing
                        algorithm.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        Keys uniquely identify list items, helping React track
                        changes and avoid rendering bugs.
                    </p>
                    <pre>
                ...
                <section>
                    ...
                    <p>
                        A library for navigation in React apps using components
                        like <code> Route </code>,{" "}
                        <code> BrowserRouter </code>, and{" "}
                        <code> Link </code>.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        Redux is a state management library based on a single
                        store, actions, reducers, and pure functions.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <ul>
                        <li>
                            <strong>React:</strong> Library, medium learning
                            curve
                        </li>
                        <li>
                            <strong>Angular:</strong> Full framework, steep
                            learning curve
                        </li>
                        <li>
                            <strong>Vue:</strong> Framework,
                            beginner-friendly
                        </li>
                    </ul>
                </section>
