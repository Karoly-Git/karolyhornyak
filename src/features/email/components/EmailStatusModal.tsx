...
export type ModalStyle = {
    modalIndex: number;
    modalBgColor: CSSProperties["backgroundColor"];
    contentOpacity: number;
    contentTop: CSSProperties["top"];
};

type EmailStatusModalProps = {
    isSending: boolean;
    isSuccess: boolean;
...
export default function EmailStatusModal({
    ...
    return (
        <div
            className="modal"
            style={{
                zIndex: modalStyle.modalIndex,
                backgroundColor: modalStyle.modalBgColor,
            }}
        >
            <div
                className="modal-content"
                style={{
                    opacity: modalStyle.contentOpacity,
                    top: modalStyle.contentTop,
                }}
            >
                <div className="modal-header">
                    <div className="modal-title">
                        {isSending ? (
                            <EmailSendingIcon className="icon" />
                        ) : isSuccess ? (
                            <EmailOkIcon className="icon success" />
                        ) : (
                            <EmailErrorIcon className="icon error" />
                        )}
